...
public class BluetoothConnectionService {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(Enter.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = mHandler.obtainMessage(Enter.MESSAGE_DEVICE_NAME);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(Enter.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(Enter.TOAST, "Unable to connect device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
